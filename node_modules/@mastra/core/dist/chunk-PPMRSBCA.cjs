...
function cloneWorkflow(workflow, opts) {
  const wf = new chunkCM4UEIAB_cjs.Workflow({
    id: opts.id,
...
var EventedWorkflow = class extends chunkCM4UEIAB_cjs.Workflow {
  constructor(params) {
    super(params);
  }
  __registerMastra(mastra) {
...
var EventedRun = class extends chunkCM4UEIAB_cjs.Run {
  constructor(params) {
    super(params);
...
var EventedExecutionEngine = class extends chunkCM4UEIAB_cjs.ExecutionEngine {
  eventProcessor;
...
//# sourceMappingURL=chunk-PPMRSBCA.cjs.map
//# sourceMappingURL=chunk-PPMRSBCA.cjs.map