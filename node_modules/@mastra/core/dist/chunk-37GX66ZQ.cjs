...
var MastraScorer = class _MastraScorer {
  ...
  toMastraWorkflow() {
    const workflowSteps = this.steps.map((scorerStep) => {
      return chunkCM4UEIAB_cjs.createStep({
        id: scorerStep.name,
    ...
    const workflow = chunkCM4UEIAB_cjs.createWorkflow({
  ...
  async executePromptStep(scorerStep, tracingContext, context) {
    ...
    const judge = new chunkCM4UEIAB_cjs.Agent({ name: "judge", model, instructions });
...
function isWorkflow(target) {
  return target instanceof chunkCM4UEIAB_cjs.Workflow;
}
...
//# sourceMappingURL=chunk-37GX66ZQ.cjs.map
//# sourceMappingURL=chunk-37GX66ZQ.cjs.map