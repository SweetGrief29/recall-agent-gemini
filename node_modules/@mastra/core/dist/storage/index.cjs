...
var InMemoryMemory = class extends MemoryStorage {
  ...
  async getMessagesById({
    ...
    const list = new chunkI77GWNQI_cjs.MessageList().add(rawMessages.map(this.parseStoredMessage), "memory");
  ...
  async saveMessages(args) {
    ...
    const list = new chunkI77GWNQI_cjs.MessageList().add(messages, "memory");
...
// src/storage/mock.ts
var InMemoryStore = class extends chunk33GDW3SI_cjs.MastraStorage {
  stores;
  constructor() {
...
Object.defineProperty(exports, "MastraStorage", {
  enumerable: true,
  get: function () { return chunk33GDW3SI_cjs.MastraStorage; }
});
