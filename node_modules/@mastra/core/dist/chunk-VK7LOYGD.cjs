...
var chunkPPMRSBCA_cjs = require('./chunk-PPMRSBCA.cjs');
var chunk37GX66ZQ_cjs = require('./chunk-37GX66ZQ.cjs');
...
async function validateAndSaveScore(storage, payload) {
  const payloadToSave = chunk37GX66ZQ_cjs.saveScorePayloadSchema.parse(payload);
...
exports.Mastra = class Mastra {
  ...
  constructor(config) {
    ...
    const workflowEventProcessor = new chunkPPMRSBCA_cjs.WorkflowEventProcessor({
      mastra: this
    });
    ...
    if (config?.observability) {
      chunkVVUCWRGD_cjs.setupAITracing(config.observability);
    }
...
`
  ...
  registerAITracingExporters() {
    const allTracingInstances = chunkVVUCWRGD_cjs.getAllAITracing();
   ...
   */
  async shutdown() {
    await chunkVVUCWRGD_cjs.shutdownAITracingRegistry();
...
//# sourceMappingURL=chunk-VK7LOYGD.cjs.map
//# sourceMappingURL=chunk-VK7LOYGD.cjs.map