...
var NewAgentNetwork = class extends chunkKXCUCBEI_cjs.MastraBase {
  ...
  async beforeRun({
    ...
    if (typeof messages === "string") {
      ...
      const messageList = new chunkI77GWNQI_cjs.MessageList({
        threadId: thread?.id,
        resourceId: thread?.resourceId
      });
  ...
  async getRoutingAgent({ runtimeContext }) {
    ...
    const instructions = `
        ...
        `;
    return new chunkCM4UEIAB_cjs.Agent({
      name: "routing-agent",
      instructions,
      model: this.#model,
      memory: memoryToUse,
  ...
  async loop(messages, {
    ...
    const finalStep = chunkCM4UEIAB_cjs.createStep({
      id: "final-step",
    ...
    const mainWorkflow = chunkCM4UEIAB_cjs.createWorkflow({
      id: "Agent-Network-Main-Workflow",
      inputSchema: zod.z.object({
        iteration: zod.z.number(),
        task: zod.z.string(),
        resourceType: chunkCM4UEIAB_cjs.RESOURCE_TYPES,
  ...
  createWorkflow({ runtimeContext }) {
    ...
    const routingStep = chunkCM4UEIAB_cjs.createStep({
      id: "routing-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
...
${completionResult.object.finalResult}` : ""}
    ...
    const agentStep = chunkCM4UEIAB_cjs.createStep({
      id: "agent-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const workflowStep = chunkCM4UEIAB_cjs.createStep({
      id: "workflow-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const toolStep = chunkCM4UEIAB_cjs.createStep({
      id: "toolStep",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const finishStep = chunkCM4UEIAB_cjs.createStep({
      id: "finish-step",
      inputSchema: zod.z.object({
        task: zod.z.string(),
        resourceId: zod.z.string(),
    ...
    const networkWorkflow = chunkCM4UEIAB_cjs.createWorkflow({
