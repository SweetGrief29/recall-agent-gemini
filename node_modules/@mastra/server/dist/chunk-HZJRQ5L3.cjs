...
var googleFailedResponseHandler = chunkHVBBFCDH_cjs.createJsonErrorResponseHandler({
...
var GoogleGenerativeAIEmbeddingModel = class {
  ...
  async doEmbed({
    ...
    const googleOptions = await chunkHVBBFCDH_cjs.parseProviderOptions({
      provider: "google",
      providerOptions,
    ...
    const mergedHeaders = chunkHVBBFCDH_cjs.combineHeaders(
...
var googleSearch = chunkHVBBFCDH_cjs.createProviderDefinedToolFactory({
...
var urlContext = chunkHVBBFCDH_cjs.createProviderDefinedToolFactory({
...
var GoogleGenerativeAILanguageModel = class {
  ...
  async doGenerate(options) {
    ...
    const {
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkHVBBFCDH_cjs.createJsonResponseHandler(responseSchema),
  ...
  async doStream(options) {
    const { args, warnings } = await this.getArgs(options);
    const body = JSON.stringify(args);
    const headers = chunkHVBBFCDH_cjs.combineHeaders(
      await chunkHVBBFCDH_cjs.resolve(this.config.headers),
      options.headers
    );
    const { responseHeaders, value: response } = await chunkHVBBFCDH_cjs.postJsonToApi({
      ...
      body: args,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkHVBBFCDH_cjs.createEventSourceResponseHandler(chunkSchema),
      abortSignal: options.abortSignal,
      fetch: this.config.fetch
    });
...
var codeExecution = chunkHVBBFCDH_cjs.createProviderDefinedToolFactoryWithOutputSchema({
...
var GoogleGenerativeAIImageModel = class {
  ...
  async doGenerate(options) {
    ...
    const { responseHeaders, value: response } = await chunkHVBBFCDH_cjs.postJsonToApi({
      ...
      headers: chunkHVBBFCDH_cjs.combineHeaders(await chunkHVBBFCDH_cjs.resolve(this.config.headers), headers),
      body,
      failedResponseHandler: googleFailedResponseHandler,
      successfulResponseHandler: chunkHVBBFCDH_cjs.createJsonResponseHandler(
...
function createGoogleGenerativeAI(options = {}) {
  var _a;
  const baseURL = (_a = chunkHVBBFCDH_cjs.withoutTrailingSlash(options.baseURL)) != null ? _a : "https://generativelanguage.googleapis.com/v1beta";
  const getHeaders = () => ({
    "x-goog-api-key": chunkHVBBFCDH_cjs.loadApiKey({
...
//# sourceMappingURL=chunk-HZJRQ5L3.cjs.map
//# sourceMappingURL=chunk-HZJRQ5L3.cjs.map