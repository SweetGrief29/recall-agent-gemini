...
var OpenAICompatibleChatLanguageModel = class {
  ...
  constructor(modelId, settings, config) {
    ...
    this.failedResponseHandler = chunkSIGXR3JT_cjs.createJsonErrorResponseHandler(errorStructure);
...
var OpenAICompatibleImageModel = class {
  ...
  async doGenerate({
    ...
    const { value: response, responseHeaders } = await chunkSIGXR3JT_cjs.postJsonToApi({
      ...
      failedResponseHandler: chunkSIGXR3JT_cjs.createJsonErrorResponseHandler(
...
function createXai(options = {}) {
  var _a;
  const baseURL = chunkSIGXR3JT_cjs.withoutTrailingSlash(
...
exports.xai = xai;
//# sourceMappingURL=chunk-5DP5XZH6.cjs.map
//# sourceMappingURL=chunk-5DP5XZH6.cjs.map