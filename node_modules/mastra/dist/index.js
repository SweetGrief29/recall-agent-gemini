#! /usr/bin/env node
import { create, checkPkgJson, checkAndInstallCoreDeps, interactivePrompt, init, logger, FileService, DepsService } from './chunk-GOKV7IM3.js';
export { create } from './chunk-GOKV7IM3.js';
...
var DevLogger = class {
  ...
  ready(host, port, startTime) {
    ...
    console.log("");
    console.log(`${pc2.dim("\u2502")} ${pc2.bold("Playground:")}   ${pc2.cyan(`http://${host}:${port}/`)}`);
